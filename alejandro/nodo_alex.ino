...
const char* mqtt_servers[] = {"10.97.193.47", "10.97.193.97"}; // 0: Fog, 1: Edge
...
void setup() {
    ...
    myServo.write(currentServoPos); // Posición inicial del servo
